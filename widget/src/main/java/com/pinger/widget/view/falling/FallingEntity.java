...
public class FallingEntity {
    ...
    public FallingEntity(Builder builder, int parentWidth, int parentHeight) {
        random = new Random();
    ...
    private FallingEntity(Builder builder) {
        this.builder = builder;
        initSpeed = builder.initSpeed;
    ...
    public static final class Builder {
        ...
        public FallingEntity build() {
            return new FallingEntity(this);
        }
    }
