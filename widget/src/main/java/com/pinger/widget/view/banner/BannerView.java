...
public class BannerView<T> extends RelativeLayout {
    ...
    private void init() {
        ...
        mViewPager = (LooperViewPager) view.findViewById(R.id.mzbanner_vp);
     ...
     * @param mzHolderCreator ViewHolder生成器 {@link BannerHolderCreator} And {@link BannerViewHolder}
     */
    ...
    private static class BannerPagerAdapter<T> extends PagerAdapter {
        private List<T> mDatas;
        ...
        BannerPagerAdapter(List<T> datas, BannerHolderCreator holderCreator, boolean canLoop) {
            if (mDatas == null) {
