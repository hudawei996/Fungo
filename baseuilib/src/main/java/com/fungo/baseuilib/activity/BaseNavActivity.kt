 ...
 */
abstract class BaseNavActivity(override val layoutResID: Int = R.layout.base_activity_nav) : BaseActivity() {
    ...
    final override fun initView() {
        ...
        if (isShowToolBar()) {
            ...
            // 左侧返回按钮
            if (isShowBackIcon()) {
                baseNavToolbar.navigationIcon = UiUtils.getBackIconFont(this)
