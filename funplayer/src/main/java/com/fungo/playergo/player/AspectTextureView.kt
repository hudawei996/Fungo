package com.fungo.playergo.player
...
/**
 * @author Pinger
 * @since 2017/10/29 0030 下午 15:21
 * 重写TextureView，适配视频的宽高和旋转.
 * （参考自节操播放器 https://github.com/lipangit/JieCaoVideoPlayer）
 */
class AspectTextureView(context: Context) : TextureView(context) {
    ...
    override fun onMeasure(widthMeasureSpecSize: Int, heightMeasureSpecSize: Int) {
        var widthMeasureSpec = widthMeasureSpecSize
        var heightMeasureSpec = heightMeasureSpecSize
